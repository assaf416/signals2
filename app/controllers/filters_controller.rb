class FiltersController < ApplicationController
  ...
  private
    ...
    def filter_params
      params.require(:filter).permit(:user_id, :name, :price_conditions, :volume_conditions, :fundamental_conditions, :pattern_conditions, :indicator_conditions, :email_notification)
    end
end
